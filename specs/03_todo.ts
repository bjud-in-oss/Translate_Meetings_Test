...
[A] 2d. Lös Netlify Deployment. (Pågående: Återinfört dynamisk generering av netlify.toml via init-script för att kringgå AI Studio-restriktioner men ändå stänga av secrets scanning).
